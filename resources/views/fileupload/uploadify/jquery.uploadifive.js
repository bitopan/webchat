        ...
        init : function(options) {
            ...
            return this.each(function() {
                ...
                var settings = $data.settings = $.extend({
                    ...
                    'simUploadLimit'  : 2,                  // The maximum number of files to upload at once
                ...
                $data.inputTemplate = $('<input type="file" accept="image/x-png,image/jpeg,application/pdf">')
                .css({
                   'opacity'  : 0,
                   'position' : 'absolute',
                   'z-index'  : 999 
                ...
                $data.queueItem = $('<div class="uploadifive-queue-item">\
                    ...
                    <div style="display:none;"><span class="filename" style="display:none;"></span><span class="fileinfo" style="display:none;"></span></div>\
					<div class="progress">\
                    ...
                    if ($.inArray('onError', settings.overrideEvents) < 0) {
                        ...
                        switch(errorType) {
                            ...
                            case 'FORBIDDEN_FILE_TYPE':
                                errorMsg = 'File Not Supported(Make sure that your file is '+settings.fileType+')';
                                break;
                ...
                if (window.File && window.FileList && window.FileReader && window.Blob) {
                    ...
                    $data.button = $('<div id="' + settings.id + '" class="btn btn-block uploadifive-button">' + settings.buttonText + '</div>');
